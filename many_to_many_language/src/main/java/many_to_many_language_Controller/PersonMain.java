package many_to_many_language_Controller;

import java.util.ArrayList;
import java.util.List;
import java.util.Scanner;

import many_to_many_language_dao.pesonDAo;
import many_to_many_language_dto.Language;
import many_to_many_language_dto.Person;

public class PersonMain {

	public static void main(String[] args) {
		Scanner scanner = new Scanner(System.in);
		pesonDAo personda = new pesonDAo();
